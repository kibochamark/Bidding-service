...
async function seed() {
    ...
    try {
        ...
        endingSoon.setHours(now.getHours() + 6);
        const endingToday = new Date(now);
        endingToday.setDate(now.getDate() + 1);
        const endingWeek = new Date(now);
        endingWeek.setDate(now.getDate() + 7);
        const endingMonth = new Date(now);
        endingMonth.setDate(now.getDate() + 30);
        console.log(endingSoon, endingToday, endingWeek, endingMonth);
        await prisma.product.create({
            data: {
                title: 'iPhone 14 Pro Max - 256GB Space Black',
                description: 'Factory unlocked iPhone 14 Pro Max in excellent condition. Includes original box, charger, and unused accessories. AppleCare+ until Dec 2025. Battery health 98%. No scratches or dents.',
        ...
        await prisma.product.create({
            data: {
                ...
                description: 'Like-new Galaxy S23 Ultra with S Pen. Minimal usage, kept in case. Comes with original packaging, 45W fast charger, and tempered glass screen protector.',
                categoryId: categoryMap['smartphones'],
                condition: 'MINT',
                images: [
        ...
        await prisma.product.create({
            data: {
                ...
                description: 'Google Pixel 8 Pro in good condition. Some minor wear on the edges but screen is pristine. Upgraded to newer model. Includes case and original charger.',
                categoryId: categoryMap['smartphones'],
                condition: 'GOOD',
                images: [
        ...
        await prisma.product.create({
            data: {
                ...
                description: 'Professional-grade MacBook Pro with M2 Max chip. Perfect for video editing and development. Barely used, purchased for project that was cancelled. Includes original box and all accessories.',
        ...
        await prisma.product.create({
            data: {
                ...
                description: 'High-performance Windows laptop for creative professionals. Excellent condition with minor keyboard wear. Great for photo/video editing and light gaming.',
                categoryId: categoryMap['laptops'],
                condition: 'GOOD',
                images: [
        ...
        await prisma.product.create({
            data: {
                ...
                description: 'Premium noise-cancelling headphones in mint condition. Used only a handful of times. Includes original case, cables, and airplane adapter. Industry-leading ANC performance.',
        ...
        await prisma.product.create({
            data: {
                ...
                description: 'Latest AirPods Pro with improved ANC and Adaptive Transparency. Excellent condition, upgraded to over-ear headphones. Includes charging case and all ear tips.',
                categoryId: categoryMap['audio'],
                condition: 'EXCELLENT',
                images: [
        ...
        await prisma.product.create({
            data: {
                ...
                description: 'Professional full-frame mirrorless camera with 24.2MP sensor. Low shutter count (2,500 actuations). Perfect for wedding and portrait photography. Includes battery, charger, and strap.',
        ...
        await prisma.product.create({
            data: {
                ...
                description: 'PS5 Digital Edition in excellent condition. Includes extra DualSense controller, HDMI cable, and power cord. Minimal usage, upgraded to disc version.',
        ...
        await prisma.product.create({
            data: {
                ...
                description: 'Latest Apple Watch in mint condition. Used for 2 months, includes original box, charger, and 3 additional bands (Sport Loop, Braided Solo, Nike Sport).',
...
//# sourceMappingURL=seed-factory.js.map